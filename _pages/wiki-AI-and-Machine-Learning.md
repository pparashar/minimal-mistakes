---
title: Awesome List - AI and Machine Learning
permalink: /awesome-resources-bookmarks-ai-and-machine-learning/
---
1. [Fast.ai Course - Computational Linear Algebra](http://www.fast.ai/2017/07/17/num-lin-alg/)
1. [Practical Deep Learning for Coders 2019](https://www.fast.ai/2019/01/24/course-v3/)
1. [Fast.ai course - Deep Learning Part 1](http://course.fast.ai/)
1. [Fast.ai Course - Cutting Edge Deep Learning Part 2](http://course.fast.ai/part2.html)
1. [Fast.ai Course - Machine Learning for Coders](https://course.fast.ai/ml.html)
1. [Dive into deep learning course - Berkley](http://d2l.ai/)
...
1. [Cornell Machine Learning Class - From Scratch](https://www.youtube.com/playlist?list=PLl8OlHZGYOQ7bkVbuRthEsaLr7bONzbXS)
1. [Free Resources for beginners on Deep Learning](https://www.analyticsvidhya.com/blog/2015/11/free-resources-beginners-deep-learning-neural-network/)
1. [A Tour of The Top 10 Algorithms for Machine Learning Newbies](https://towardsdatascience.com/a-tour-of-the-top-10-algorithms-for-machine-learning-newbies-dde4edffae11)
1. [MNIST for ML beginners](https://github.com/alpha-i/blog/blob/master/notebooks/20170609_MNIST_For_ML_Beginners_The_Bayesian_Way.ipynb)
...
1. [Applications of Deep Learning](http://cs231n.stanford.edu/reports.html)
1. [Solving logistic regression](http://thelaziestprogrammer.com/sharrington/math-of-machine-learning/solving-logreg-newtons-method)
1. [An Overview of Multi-Task Learning in Deep Neural Networks](http://ruder.io/multi-task/)
1. [Probability Theory Book - by Jaynes](http://www.med.mcgill.ca/epidemiology/hanley/bios601/GaussianModel/JaynesProbabilityTheory.pdf)
1. [Building music recommender using Deep Learning](http://mattmurray.net/building-a-music-recommender-with-deep-learning/)
1. [Book - Artificial Intelligence a modern approach by Stuart Russel](http://aima.cs.berkeley.edu/)
1. [Awesome Machine Learning Resources - Programming](https://github.com/josephmisiti/awesome-machine-learning)
...
1. [Awesome Data Science Resources](https://github.com/bulutyazilim/awesome-datascience)
1. [AI Cheat Sheets](https://github.com/kailashahirwar/cheatsheets-ai)
1. [Oxford Deep NLP lectures](https://github.com/oxford-cs-deepnlp-2017/lectures)
1. [Pytorch Tutorial](https://github.com/yunjey/pytorch-tutorial)
1. [Mobile Deep Learning](https://github.com/baidu/mobile-deep-learning)
1. [Deep speech](https://github.com/mozilla/DeepSpeech)
1. [macOS for deep learning with Python, TensorFlow, and Keras](https://www.pyimagesearch.com/2017/09/29/macos-for-deep-learning-with-python-tensorflow-and-keras/)
1. [Automatic License Plate Recognition library](http://www.openalpr.com)
1. [Google Colab Free GPU Tutorial](https://medium.com/deep-learning-turkey/google-colab-free-gpu-tutorial-e113627b9f5d)
1. [Markov Chains in Python: Beginner Tutorial](https://www.datacamp.com/community/tutorials/markov-chains-python-tutorial)
1. [Mathematics for Machine Learning Book](http://mml-book.com/)
1. [Technical Book on Deep Learning](https://github.com/tomepel/Technical_Book_DL)
1. [Understanding Basic Machine Learning Algorithms](https://github.com/trekhleb/homemade-machine-learning)
1. [Book - Introduction to Applied Linear Algebra – Vectors, Matrices, and Least Squares](http://vmls-book.stanford.edu/)
1. [Video Introduction to Bayesian Data Analysis, Part 1: What is Bayes?](http://www.sumsar.net/blog/2017/02/introduction-to-bayesian-data-analysis-part-one/)
...
1. [Book - Understanding Machine Learning: From Theory to Algorithms](https://www.cse.huji.ac.il/~shais/UnderstandingMachineLearning/understanding-machine-learning-theory-algorithms.pdf)
1. [Book - Foundations of Data Science by Avrim Blum, John Hopcroft, and Ravindran Kannan](https://www.cs.cornell.edu/jeh/book.pdf)
1. [Book - a brief introduction to Neural Networks](http://www.dkriesel.com/_media/science/neuronalenetze-en-zeta2-2col-dkrieselcom.pdf)
1. [Book - Elemenst of Statistical Learning](https://web.stanford.edu/~hastie/ElemStatLearn/printings/ESLII_print12.pdf)
...
1. [Thinking in tensors writing in Pytorch](https://github.com/stared/thinking-in-tensors-writing-in-pytorch)
1. [A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in python using Scikit-Learn and TensorFlow](https://github.com/ageron/handson-ml)
1. [Deep learning with Python and Pytorch Course](https://www.edx.org/course/deep-learning-with-python-and-pytorch-2)
1. [Deep Neural Networks with Pytorch](https://www.coursera.org/learn/deep-neural-networks-with-pytorch)
1. [ML from Scratch](http://www.oranlooney.com/post/ml-from-scratch-part-0-introduction/)
...
1. [Harvard CS 109[(http://cs109.github.io/2015/pages/videos.html)
1. [Stanford 2017 - Lecture Collection - Convolutional Neural Networks for Visual Recognition](https://www.youtube.com/playlist?list=PL3FW7Lu3i5JvHM8ljYj-zLfQRF3EO8sYv)
1. [Neural Networks class](https://www.youtube.com/watch?list=PL6Xpj9I5qXYEcOhn7TqghAJ6NAPrNmUBH)
1. [Pytorch at Tesla by Karpathy](https://www.youtube.com/watch?v=oBklltKXtDE)
...
1. [Machine Learning Projects for beginners](https://elitedatascience.com/machine-learning-projects-for-beginners)
1. [How to get started on ML](https://machinelearningmastery.com/start-here/)
1. [Machine Learning Infrastructure at Netflix](https://www.infoq.com/presentations/netflix-ml-infrastructure/)
1. [70+ Machine Learning Datasets – Gain real-world experience with Data Science projects](https://data-flair.training/blogs/machine-learning-datasets/)
1. [Predicting the Stock price Using TensorFlow](https://morioh.com/p/ec43f2c04d26)
1. [CCSM: Scalable statistical anomaly detection to resolve app crashes faster - Facebook](https://engineering.fb.com/developer-tools/ccsm/)
1. [Prediction and Analysis of Time Series Data using Tensorflow](https://towardsdatascience.com/prediction-and-analysis-of-time-series-data-using-tensorflow-2136ef633018)
