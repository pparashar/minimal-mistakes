---
title: Awesome List - Probability & Statistics
permalink: /awesome-resources-bookmarks-probability-statistics/
---
1. [A visual introduction to probability and statistics](https://seeing-theory.brown.edu/)
1. [Paradoxes of Probability and statistics](http://quillette.com/2017/05/26/paradoxes-probability-statistical-strangeness/)
2. [Probability and Statistics Cookbook](http://pages.cs.wisc.edu/~tdw/files/cookbook-en.pdf)
1. [Introduction to Statistics using NumPy](https://mubaris.com/2017/09/09/introduction-to-statistics-using-numpy/)
